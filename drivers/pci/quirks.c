...
static void quirk_ampere_erratum_82288(struct pci_dev *dev)
{
	pr_info_once("Write combining PCI maps disabled due to hardware erratum\n");
	have_ampere_erratum_82288 = true;
}
DECLARE_PCI_FIXUP_EARLY(PCI_VENDOR_ID_AMPERE, 0xe100, quirk_ampere_erratum_82288);
#endif
